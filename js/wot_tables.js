...
//--------Новости
	...
	tmstat10 = $('#techMT').jqGrid({
		...
		rowNum: 100,
		hiddengrid:true,
		caption: '<img src="images/icons/mt.png"/> Средние танки',
		rownumbers: false,
		rownumWidth: 40,
		grouping: false,
		toolbar: false,
	...
	tmstat10 = $('#techLT').jqGrid({
		...
		rowNum: 100,
		hiddengrid:true,
		caption: '<img src="images/icons/lt.png"/> Лёгкие танки',
		rownumbers: false,
		rownumWidth: 40,
		grouping: false,
		toolbar: false,
	...
	tmstat10 = $('#techSAU').jqGrid({
		...
		rowNum: 100,
		hiddengrid:true,
		caption: '<img src="images/icons/spg.png"/> САУ',
		rownumbers: false,
		rownumWidth: 40,
		grouping: false,
		toolbar: false,
	...
	tmstat10 = $('#techAT').jqGrid({
		...
		rowNum: 100,
		hiddengrid:true,
		caption: '<img src="images/icons/at.png"/> ПТ-САУ',
		rownumbers: false,
		rownumWidth: 40,
		grouping: false,
		toolbar: false,
