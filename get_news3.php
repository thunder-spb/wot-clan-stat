...
for($i=0;$i<$count;$i++) { 
	...
	if ($a<>14){
		...
		$amessage='<img src="images/MarkOfMastery4.png" style="width: 20px; height:20px;" align="absmiddle"/> на '.$tname." у ".$pname;
		$sp5="<b>";$sp6="</b>";
		if($row['level']==10) {$sp5="<span style='color: blue;'><b>"; $sp6="</b></span> ";}
		if($row['level']==9) {$sp5="<span style='color: green;'><b>"; $sp6="</b></span> ";}
		$amessage=$sp5.$amessage.$sp6;
	}
